...
async function getAll(path) {
  // Retorna uma lista de objetos {id, ...dados}
...
// CRUD helpers for entradas/saidas
...
// Cria objeto global para uso direto em scripts não-module
const DB = {
  initFirebase,
  getAll,
  addItem,
